...
void system_clock_init(void)
{
	...
	clr_src_cpu = MUX_APLL_SEL(1) | MUX_CORE_SEL(1) | MUX_HPM_SEL(1) | MUX_MPLL_USER_SEL_C(1);
	set = MUX_APLL_SEL(0) | MUX_CORE_SEL(0) | MUX_HPM_SEL(0) | MUX_MPLL_USER_SEL_C(0);
	...
	clr = APLL_RATIO(7) |CORE_RATIO(7)| CORE2_RATIO(7)| COREM0_RATIO(7) | COREM1_RATIO(7) | PERIPH_RATIO(7) | ATB_RATIO(7) | PCLK_DBG_RATIO(7) ;
	set = APLL_RATIO(1) |CORE_RATIO(0) | CORE2_RATIO(0) | COREM0_RATIO(3) | COREM1_RATIO(7)| PERIPH_RATIO(0) | ATB_RATIO(6) | PCLK_DBG_RATIO(1) ;
...
/*=====================set MPLL related dividers(CMU_DMC)==============================*/
	...
	clr = DMC_RATIO(7) | DMCD_RATIO(7) | DMCP_RATIO(7) | ACP_RATIO(7) | ACP_PCLK_RATIO(7) | DPHY_RATIO(7);
	set = DMC_RATIO(1) | DMCD_RATIO(1) | DMCP_RATIO(1) | ACP_RATIO(3) | ACP_PCLK_RATIO(1) | DPHY_RATIO(1);
	...
	clr = C2C_RATIO(7) | C2C_ACLK_RATIO(7) | PWI_RATIO(15) | G2D_ACP_RATIO(15) | DVSEM_RATIO(127) | DPM_RATIO(127);
	set = C2C_RATIO(1) | C2C_ACLK_RATIO(1) | PWI_RATIO(7) | G2D_ACP_RATIO(3) | DVSEM_RATIO(1) | DPM_RATIO(1);
	...
	clr = ACLK_400_MCUISP_RATIO(7) | ACLK_200_RATIO(7) | ACLK_266_GPS_RATIO(7) | ACLK_100_RATIO(15) | ACLK_160_RATIO(7) | ACLK_133_RATIO(7) |ONENAND_RATIO(7);
	set = ACLK_400_MCUISP_RATIO(1) | ACLK_200_RATIO(4) | ACLK_266_GPS_RATIO(2) | ACLK_100_RATIO(7) | ACLK_160_RATIO(4) | ACLK_133_RATIO(5) |ONENAND_RATIO(1);
	 ...
	 */
	set = MMC0_RATIO(7) | MMC0_PRE_RATIO(1) | MMC1_RATIO(7) | MMC1_PRE_RATIO(1);
	 ...
	 */
	set = MMC2_RATIO(7) | MMC2_PRE_RATIO(1) | MMC3_RATIO(7) | MMC3_PRE_RATIO(1);
	...
	/**************** Set APLL to 1400MHz ****************/
	/*APLL_CON1*/
	clr = AFC(15) | LOCK_CON_DLY(15) | LOCK_CON_IN(3) | LOCK_CON_OUT(3) |FEED_EN(1)| AFC_ENB(1) | DCC_ENB(1) | BYPASS(1) |RESV0(1) | RESV1(1);
	set = AFC(0) | LOCK_CON_DLY(8) | LOCK_CON_IN(3) | LOCK_CON_OUT(0) |FEED_EN(0)| AFC_ENB(0) | DCC_ENB(0) | BYPASS(0) |RESV0(1) | RESV1(0);
	...
	/**************** Set EPLL to 96MHz ****************/
	/*EPLL_CON2*/
	clr = BYPASS_E_V(1) | SSCG_EN(1) | AFC_ENB_E_V(1) |DCC_ENB_E_V(1) ;
	set = BYPASS_E_V(1) | SSCG_EN(1) | AFC_ENB_E_V(1) |DCC_ENB_E_V(1) ;
	...
	/* CLK_SRC_PERIL0 */
	clr = UART0_SEL(15) | UART1_SEL(15) | UART2_SEL(15) | UART3_SEL(15) | UART4_SEL(15);
	...
	/* CLK_SRC_TOP0 */
	clr = MUX_EPLL_SEL(1) | MUX_VPLL_SEL(1) | MUX_ACLK_200_SEL(1) | MUX_ACLK_100_SEL(1) | MUX_ACLK_160_SEL(1) | MUX_ACLK_133_SEL(1) | MUX_ONENAND_SEL(1) | MUX_ONENAND_1_SEL(1);
	set = MUX_EPLL_SEL(1) | MUX_VPLL_SEL(1) | MUX_ACLK_200_SEL(0) | MUX_ACLK_100_SEL(0) | MUX_ACLK_160_SEL(0) | MUX_ACLK_133_SEL(0) | MUX_ONENAND_SEL(0) | MUX_ONENAND_1_SEL(0);
	clrsetbits_le32(&clk->src_top0, clr, set);
	/* Wait for mux change */
	sdelay(0x30000);

	/* CLK_SRC_TOP1 */
	clr = MUX_MPLL_USER_SEL_T(1) | MUX_ACLK_400_MCUISP_SEL(1) | MUX_ACLK_400_MCUISP_SUB_SEL(1) | MUX_ACLK_200_SUB_SEL(1) | MUX_ACLK_266_GPS_SEL(1) | MUX_ACLK_266_GPS_SUB_SEL(1);
	set = MUX_MPLL_USER_SEL_T(1) | MUX_ACLK_400_MCUISP_SEL(0) | MUX_ACLK_400_MCUISP_SUB_SEL(1) | MUX_ACLK_200_SUB_SEL(1) | MUX_ACLK_266_GPS_SEL(0) | MUX_ACLK_266_GPS_SUB_SEL(1);
	 ...
	 */
	clr_src_dmc = MUX_C2C_SEL(1) | MUX_DMC_BUS_SEL(1) | MUX_DPHY_SEL(1) | MUX_MPLL_SEL(1) | MUX_PWI_SEL(15) | MUX_G2D_ACP0_SEL(1) | MUX_G2D_ACP1_SEL(1) | MUX_G2D_ACP_SEL(1);
	set = MUX_MPLL_SEL(1) | MUX_C2C_SEL(0) | MUX_DMC_BUS_SEL(0) | MUX_DPHY_SEL(0) | MUX_PWI_SEL(6) | MUX_G2D_ACP0_SEL(0) | MUX_G2D_ACP1_SEL(0) | MUX_G2D_ACP_SEL(0);
